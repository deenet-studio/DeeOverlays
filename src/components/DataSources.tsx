...
export function DataSources({ sources, onCheck, onDisconnect }: Props) {
  return <section className="data-sources"><div className="sources-heading"><p>Данные</p><h2>Источники данных</h2><small>Демо-режим работает сразу. VK Видео подключается через локальный integration server.</small></div>
