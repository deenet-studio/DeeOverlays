...
type Props = { items: OverlayItem[]; selectedId: OverlayId; onSelect: (id: OverlayId) => void; onToggle: (id: OverlayId) => void; dataSources: Record<DataSourceId, DataSourceConnection>; onCheckSource: (id: DataSourceId) => void }
export function Sidebar({ items, selectedId, onSelect, onToggle, dataSources, onCheckSource }: Props) {
  ...
  </div><DataSources sources={dataSources} onCheck={onCheckSource} /></aside>
}
