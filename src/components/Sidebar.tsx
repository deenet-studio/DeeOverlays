...
type Props = { items: OverlayItem[]; selectedId: OverlayId; onSelect: (id: OverlayId) => void; onToggle: (id: OverlayId) => void; dataSources: Record<DataSourceId, DataSourceConnection> }
export function Sidebar({ items, selectedId, onSelect, onToggle, dataSources }: Props) {
  ...
  </div><DataSources sources={dataSources} /></aside>
}
